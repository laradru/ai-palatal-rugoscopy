...
TRAIN_TRAINING_ANNOTATIONS_FILENAME = annotations.json
TRAIN_TRAINING_ANNOTATIONS_PATH = ${DATA_ROOT}/${CVAT_EXPORT_ROOT}/output/patches/training/annotations/${TRAIN_TRAINING_ANNOTATIONS_FILENAME}
TRAIN_VALIDATION_IMAGES_PATH = ${DATA_ROOT}/${CVAT_EXPORT_ROOT}/output/patches/validation/images
TRAIN_VALIDATION_ANNOTATIONS_FILENAME = annotations.json
TRAIN_VALIDATION_ANNOTATIONS_PATH = ${DATA_ROOT}/${CVAT_EXPORT_ROOT}/output/patches/validation/annotations/${TRAIN_VALIDATION_ANNOTATIONS_FILENAME}
TRAIN_OUTPUT_PATH = ${DATA_ROOT}/${CVAT_EXPORT_ROOT}/output/train/${PATCH_SIZE}/
TRAIN_BATCH_SIZE = 2
